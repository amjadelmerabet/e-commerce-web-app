                                ...
                                props.filter.elements.options.map((option) => {
                                    if(!props.filter.elements.withSubcategories) {
                                        if(props.filter.label !== 'Prices') {
                                            return (
                                                <ListGroup.Item key={option.id} action>
                                                    {option.label}
                                                </ListGroup.Item>
                                            )
                                        }
                                            ...
                                            return (
                                                <ListGroup.Item key={option.id} onClick={() => {
                                                    props.data.setPriceMin(option.min)
                                                    props.data.setPriceMax(option.max)
                                                }} action>
                                                    {option.label}
                                                </ListGroup.Item>
                                            )
                                        ...
                                        return (
                                            <ListGroup key={option.id}>
                                                <ListGroup.Item>
                                                    <FilterSubAccordion option={option} data={{setCategory: props.data.setCategory.bind()}} />
                                                </ListGroup.Item>
                                            </ListGroup>
                                        )
                                    }

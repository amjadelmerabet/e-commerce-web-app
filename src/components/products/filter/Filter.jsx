            ...
            <div className="filter-header">
                <Row className="p-3">
                    ...
                    <Col xs={6} md={6} lg={6} className="d-flex justify-content-end">
                        <Button size="sm" className="filter-button px-3 border-0" onClick={() => {
            ...
            <div className="filter-body">
                {
                    Data.body.products.filterTab.filters.map((filter) => {
                        if(props.data.urlCategory !== 'all' && filter.label !== 'Categories') {
                            return (
                                <FilterAccordion key={filter.id} filter={filter} data={{setCategory: props.data.setCategory.bind(), setPriceMin: props.data.setPriceMin.bind(), setPriceMax: props.data.setPriceMax.bind()}} />
                            )
                        }
                        if(props.data.urlCategory === 'all') {
                            return (

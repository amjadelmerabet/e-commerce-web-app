...
function SortedProducts(props) {
    ...
    const products = sorting_by_price(props.data.products, props.data.sortFromLowToHigh.lowToHigh);

    return (
        <InfiniteScroll products={products} data={{productName: props.data.productName, category: props.data.category, filterByCategory: props.data.filterByCategory.bind()}} />
    );
}
